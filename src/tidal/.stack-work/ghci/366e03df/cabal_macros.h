...
/* package tidal-runner-0.1.0 */
#ifndef VERSION_tidal_runner
#define VERSION_tidal_runner "0.1.0"
#endif /* VERSION_tidal_runner */
#ifndef MIN_VERSION_tidal_runner
#define MIN_VERSION_tidal_runner(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_tidal_runner */
...
#define CURRENT_COMPONENT_ID "tidal-runner-0.1.0-Hym5PkMREbZEh0IPX4Cgzy-tidal-runner"
